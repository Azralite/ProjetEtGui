...
public class SimpleFrameTest extends JFrame {
    ...
    private static String PATH = "src/ressource/classement.json";
    private static String[] classement;

    public SimpleFrameTest(JLabel username, int score) {
    ...
    public void initComponents(JLabel username, int score) {
    ...
    public static String[] printJson(String username, int score){
        ...
        try{
            ...
            for(int i = 0; i<jsonArray.size(); i++){
                ...
                if(Integer.parseInt(String.valueOf(jsonObject.get("score"))) <= score){
